...
/**
 * Server fetches throw by design, and this page's whole content is one — without this file
 * a dropped API connection is a white screen (AGENTS.md rule 6).
 */
export default function ThaiAlphabetError({
  error,
  unstable_retry,
}: {
  ...
  useEffect(() => {
    console.error("[thai-alphabet-error]", error);
  }, [error]);
